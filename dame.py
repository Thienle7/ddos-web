...
if str(platform.system()) == 'Linux':
    ...
    print("                            "+Fore.LIGHTGREEN_EX +"╔═════════╩═════════════════════════════════╩═════════╗")
    print("                            "+Fore.LIGHTGREEN_EX +"║  \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Coder   "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" Le The Thien"+Fore.LIGHTGREEN_EX+"                      ║")
    print("                            "+Fore.LIGHTGREEN_EX +"║  \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Github  "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" chua co"+Fore.LIGHTGREEN_EX+"         ║")
    print("                            "+Fore.LIGHTGREEN_EX +"║  \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Facebook"+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" 0"+Fore.LIGHTGREEN_EX+"   ║")
    print("                            "+Fore.LIGHTGREEN_EX +"╚═════════════════════════════════════════════════════╝") 
    print("")
